...
"""
Escreva um programa (notas.py) que receba um numero inteiro n correspondente a um valor em reais.
Calcule a quantidade mínima de notas que um banco deve fornecer para atingir o valor, sabendo que as notas disponíveis sao de 100, 50, 20, 10 e 5 reais.
"""
